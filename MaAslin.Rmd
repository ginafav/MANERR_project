...
```{r}
setwd("/Users/gla589/Documents/Research/Manerr_Sup_Info/Manerr_Table_Info")
#Read in the new file. This will be your input data
input_data <- read.table("/Users/gla589/Documents/Research/Manerr_Sup_Info/Manerr_Table_Info/coverm_taxa_for_maaslin2.tsv", row.names = 1, header = TRUE)
...
# Running on just one fixed effects without normalizing. Ended up using this
fit_data2 = Maaslin2(
...
# Running on just one fixed effects without normalizing. Ended up using this
fit_data1 = Maaslin2(
  input_data, input_metadata, output = 'maaslin2_feb_19_vegetation', 
  fixed_effects = "Vegetation", normalization = 'NONE', standardize = FALSE,
  reference = "Vegetation,Mangrove",
 max_significance = 0.05,# or your baseline
)
...
fit_data4 = Maaslin2(
  input_data, input_metadata2, output = 'maaslin2_feb_19_depth', 
